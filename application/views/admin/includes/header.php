        ...
        <div class="main-header-right">
            ...
            <div class="dropdown main-profile-menu">
                <a class="d-flex profile-item"  href="">
                  <?php if($_SESSION['FR_IMG']):?>
                    <img src="arquivos/profile/<?=$_SESSION['FR_UID']?>/<?=$_SESSION['FR_IMG']?>" class="rounded-circle img-thumbnail " style="max-width: 40px !important;" alt="avatar">
                  <?php else:?>
                ...
                <div class="dropdown-menu">
                    ...
                    <a class="dropdown-item" href="admin_login/logout">
        ...
        <div class="topbar-menu row">
            <div class="col-lg-9 col-md-8 col-sm-12 animated animated-short fadeInDown" style="z-index: 1030;">
                ...
                <ul  class="top-sistemas">
                    ...
                    $sysm = [];
                    if ($this->session->userdata("FR_GRUPO") != 1) {
                        $sysm = array_keys(unserialize($this->session->userdata("FR_PERMISSOES")));
                    }
                    /* Verifica quais sistemas tenho permissão */
                    foreach ($systemas as $systema):
                        if (in_array($systema->sys_id, $sysm) || $this->session->userdata("FR_GRUPO") == 1 || $this->session->userdata("SIC_USURPADOR") > 0):?>
                            <li>
                                <a href="profile/changesistema/<?= $systema->sys_id ?>" class="" style="opacity: 1;">
                                    <span class="glyphicon <?= $systema->sys_icone ?>"></span>
                                    <span class="metro-title"><?= $systema->sys_titulo?></span>
                                </a>
                            </li>
                        <?php endif;
                    endforeach;
